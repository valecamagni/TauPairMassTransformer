...
from utils import _pad, compute_new_features, compute_invariant_masses, tau_tau_preprocessing, mass_plot, SVFit_input, str2bool, delta_r_numpy, compute_delta_r
...
with open(log_file, "w") as file:
    ...
    for data_chunk in uproot.iterate(
        ...
        # Chunck process
        data_chunk["Tau"]= data_chunk["Tau"][ak.argsort(data_chunk["Tau"]["pt"], ascending=False)]
